...
import static org.tdl.vireo.services.SubmissionParams.Variable.STUDENT_NETID;
...
public class TemplatePackagerImplTest extends AbstractPackagerTest { // subclass to get test helpers and share setup
	...
	@Test public void testAllTemplateVariables() throws Exception {
		...
		packager.setManifestTemplatePath("test/org/tdl/vireo/export/impl/TestSingleTemplate.xml".replace('/', File.separatorChar));
	...
	@Test public void test_stock_VireoExport() throws Exception {
		...
		packager.setManifestTemplatePath("conf/formats/vireo.xml".replace('/', File.separatorChar));
	...
	@Test public void test_stock_DSpaceMETS() throws Exception {
		...
		packager.setManifestTemplatePath("conf/formats/dspace_mets.xml".replace('/', File.separatorChar));
	...
	@Test public void test_stock_GenericQDC() throws Exception {
		...
		packager.setFormat("http://purl.org/dc/elements/1.1/");
		packager.setManifestTemplatePath("conf/formats/qdc.xml".replace('/', File.separatorChar));
	...
	@Test public void test_stock_Marc21() throws Exception {
		...
		packager.setManifestTemplatePath("conf/formats/marc21.xml".replace('/', File.separatorChar));
	...
	@Test public void test_stock_ProQuest() throws Exception {
		...
		packager.setManifestTemplatePath("conf/formats/ProquestUMI.xml".replace('/', File.separatorChar));
	...
	@Test public void testSetManifestNameAndPath() {
		...
		try {
			packager.setManifestTemplatePath("conf/formats/nope.xml".replace('/', File.separatorChar));
	...
	@Test public void testSetTemplatePaths() {
		...
		// single works
		templatePaths.put("name1", "conf/formats/vireo.xml".replace('/', File.separatorChar));
		packager.setTemplatePaths(templatePaths);
		assertEquals(1, packager.templates.size());
		...
		// double is error
		templatePaths.put("name2", "conf/formats/qdc.xml".replace('/', File.separatorChar));
		try {
			packager.setTemplatePaths(templatePaths);
