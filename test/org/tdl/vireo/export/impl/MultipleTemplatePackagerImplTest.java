...
public class MultipleTemplatePackagerImplTest extends AbstractPackagerTest {
    ...
    @Test public void testFilenameCollision() throws Exception {
        ...
        for(AbstractPackagerImpl.PackageType packageType : AbstractPackagerImpl.PackageType.values()) {
            ...
            templatePaths.put("filename-collision-last name.pdf", "test/org/tdl/vireo/export/impl/TestMultipleTemplate.xml");
            templatePaths.put("filename-collision-{"+LAST_NAME+"}.pdf", "test/org/tdl/vireo/export/impl/TestMultipleTemplate.xml");
            packager.setTemplatePaths(templatePaths);
            ...
            String templateArg0 = xpath.evaluate("/test/currentTemplate", doc0);
            String file1="filename-collision-last name_1.pdf";
            Document doc1 = getFileXML(fileMap, file1);
            String templateArg1 = xpath.evaluate("/test/currentTemplate", doc1);
    ...
    @Test public void testFileSeparators_customizationReplacement() throws IOException {
        ...
        Map<String, String> templatePaths = new HashMap<String, String>(4);
        templatePaths.put("template-{" + FIRST_NAME + "}.xml", "test/org/tdl/vireo/export/impl/TestMultipleTemplate.xml");
        packager.setTemplatePaths(templatePaths);
        ...
        assertNotNull(fileMap.remove("dir-Annoying-Name/file-Annoying-Name.pdf"));
